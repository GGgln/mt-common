    ...
    <div class="container-min">
      <a-form :form="form">
        <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="姓名:">
          <a-input v-decorator="['userName', { initialValue: details.customerName, rules: [{ required: true, message: '姓名不能为空' }] }]" />
        </a-form-item>

        <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="角色:">
          <a-select disabled v-decorator="['roleTypeId', { initialValue: details.roleTypeCode, rules: [{ required: true, message: '请选择角色' }] }]">
