    ...
    >
      <a-form :form="form">
        ...
        <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="用户名:" hasFeedback>
          <a-input
            id="warning"
            v-decorator="['userId', { rules: [{ required: true, message: '不能为空' }, { validator: handleUserId}] }]"
          />
        </a-form-item>
        ...
        <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" label="电话:" hasFeedback>
          <a-input
            id="warning"
            v-decorator="['phone', { rules: [{ required: true, message: '不能为空' }, { validator: handIphone }] }]"
          />
        </a-form-item>
